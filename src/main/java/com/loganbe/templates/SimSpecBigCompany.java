...
public class SimSpecBigCompany {
    ...
    public static final int VMS = HOSTS;                   // virtual hosts (avg 100 VM's per host)
    ...
    public static final int CLOUDLETS = HOSTS*24;          // base on number of available cores, X2 - i.e. will execute 2 batches sequentially

    public static final int CLOUDLET_PES = HOST_PES;                // NOT how many cores to use, rather how many are needed! (or how many it's allowed to use!?)
